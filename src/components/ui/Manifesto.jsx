    ...
    <section ref={containerRef} className="py-40 px-6 bg-white text-black relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-32 relative z-10">
            ...
            <motion.div style={{ y: y1, opacity: opacity1 }} className="space-y-6">
                <span className="text-black/30 font-semibold text-[10px] tracking-[0.5em] uppercase mb-8 block">01 / The Noise</span>
                <p className="font-serif text-4xl md:text-6xl leading-tight italic">
                    The world is screaming. <br/>
                    Your phone is blinking.
                </p>
                <p className="font-sans text-xs tracking-[0.4em] uppercase text-black/40">
                    Find the space between the notes.
                </p>
            </motion.div>

            {/* Stanza 2: The Rebellion */}
            <motion.div style={{ y: y2, opacity: opacity2 }} className="max-w-2xl mx-auto border-y border-black/5 py-16">
                <span className="text-black/30 font-semibold text-[10px] tracking-[0.5em] uppercase mb-8 block">02 / The Cure</span>
                <p className="font-sans text-lg md:text-xl tracking-wide leading-relaxed font-light text-black/80 italic">
            ...
            <motion.div style={{ y: y3, opacity: opacity3 }} className="space-y-8">
                <span className="text-black/30 font-semibold text-[10px] tracking-[0.5em] uppercase mb-8 block">03 / The Ritual</span>
                ...
                <div className="pt-12">
                     <button className="border border-black text-black px-10 py-4 rounded-none text-xs font-semibold uppercase tracking-[0.3em] hover:bg-black hover:text-white transition-all duration-500">
                        Our Story
                     </button>
                </div>
            </motion.div>
