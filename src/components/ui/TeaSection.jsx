    ...
    <section ref={containerRef} className="relative min-h-screen py-24 flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto w-full px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`relative ${align === 'right' ? 'lg:order-2' : 'lg:order-1'}`}>
                ...
                >
                    <span className={`text-9xl font-serif text-transparent bg-clip-text bg-gradient-to-br from-tl-soot/10 to-transparent pointer-events-none select-none`}>
                        {title.split(' ')[0]}
                    </span>
                </motion.div>
            </div>
            ...
            <div className={`${align === 'right' ? 'lg:order-1' : 'lg:order-2'}`}>
                ...
                >
                    ...
                    <button className={`px-8 py-4 border border-tl-soot/20 text-tl-soot hover:border-tl-soot transition-colors duration-300 uppercase tracking-widest text-xs font-medium`}>
                        Shop Collection
                    </button>
                </motion.div>
            </div>
