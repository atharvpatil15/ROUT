...
import founderOneImg from '@/assets/111.jpg';
import founderTwoImg from '@/assets/222.jpg';

const toSrc = (image) => (typeof image === 'string' ? image : image?.src || '');

const About = () => {
  return (
    <div className="bg-tl-paper min-h-screen pb-32 font-sans selection:bg-tl-matcha selection:text-white">
        ...
        <div className="relative h-[80vh] flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 z-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-tl-paper" />
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-24 space-y-40">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 md:order-2 relative aspect-square md:aspect-[4/5] overflow-hidden rounded-sm">
                     <img src={toSrc(orthodoxImg)} alt="Chaos" className="w-full h-full object-cover grayscale contrast-125" />
                </div>
            </div>
        ...
        <section className="max-w-6xl mx-auto px-6 py-24 border-t border-tl-soot/10">
            <div className="text-center mb-20">
                <span className="text-tl-matcha uppercase tracking-[0.2em] text-[10px] font-bold mb-3 block">Our Leadership</span>
                <h2 className="font-serif text-4xl text-tl-soot">The Architects</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                {[
                    ...
                    <motion.div 
                        ...
                        className="bg-white p-8 rounded-3xl border border-tl-soot/5 shadow-sm hover:shadow-lg transition-all duration-500 group"
                    >
                        <div className="flex items-center gap-6 mb-6">
                            <div className="w-20 h-20 rounded-full overflow-hidden shrink-0 border border-tl-soot/10">
                            ...
                            <div>
                                <h3 className="font-serif text-2xl text-tl-soot">{founder.name}</h3>
                                <p className="text-xs font-bold text-tl-matcha uppercase tracking-widest mt-1">{founder.role}</p>
                            </div>
                        </div>
                        <p className="text-sm text-tl-soot/70 italic font-light leading-relaxed">
                            "{founder.quote}"
                        </p>
                    </motion.div>
                ))}
